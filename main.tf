...
module "rds" {
  source = "github.com/mobiqa/tf-module-rds"
  env    = var.env
...
module "elasticache" {
  source = "github.com/mobiqa/tf-module-elasticache"
  env    = var.env
...
module "rabbitmq" {
  source       = "github.com/mobiqa/tf-module-rabbitmq"
  env          = var.env
...
module "alb" {
  source = "github.com/mobiqa/tf-module-alb"
  env    = var.env
...
#module "apps" {
#  source = "github.com/mobiqa/tf-module-app"
#  env    = var.env
#
